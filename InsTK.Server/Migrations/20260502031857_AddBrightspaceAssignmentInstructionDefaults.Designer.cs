...
namespace InsTK.Server.Migrations
{
    ...
    [Migration("20260502031857_AddBrightspaceAssignmentInstructionDefaults")]
    partial class AddBrightspaceAssignmentInstructionDefaults
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsTK.Server.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("InsTK.Shared.Models.Tutorials.TutorialDefinition", b =>
                {
                    ...
                    b.Property<string>("BrightspaceAssignmentInstructions")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BrightspaceAssignmentTitle")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("BrightspacePoints")
                        .HasColumnType("int");

                    b.Property<string>("BrightspaceSubmissionInstructions")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ConclusionMarkdown")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InsTK.Shared.Models.Tutorials.TutorialStep", b =>
                {
                    ...
                    b.HasIndex("TutorialDefinitionId");
            ...
            modelBuilder.Entity("InsTK.Shared.Models.Tutorials.TutorialStep", b =>
                {
                    b.HasOne("InsTK.Shared.Models.Tutorials.TutorialDefinition", "TutorialDefinition")
                        .WithMany("Steps")
                        .HasForeignKey("TutorialDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TutorialDefinition");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InsTK.Server.Data.ApplicationUser", null)
                        .WithMany()
