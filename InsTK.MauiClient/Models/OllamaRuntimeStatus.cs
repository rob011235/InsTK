...
/// <param name="RequiredWindowsZipSha256">The expected SHA-256 digest for the managed Windows runtime zip.</param>
/// <param name="DetectedVersion">The version detected from the managed runtime, if any.</param>
/// <param name="ServerVersion">The version reported by the currently reachable Ollama endpoint, if any.</param>
...
/// <param name="ConflictDetected">A value indicating whether another Ollama instance appears to conflict with the managed policy.</param>
...
public sealed record OllamaRuntimeStatus(
    ...
    string RequiredWindowsZipSha256,
